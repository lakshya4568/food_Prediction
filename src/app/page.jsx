          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/predict"
                  className="inline-flex items-center justify-center px-8 py-4 bg-green-500 hover:bg-green-600 text-white font-bold rounded-lg transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                ...
                <Link
                  href="#how-it-works"
                  className="inline-flex items-center justify-center px-8 py-4 border-2 border-green-500 text-green-500 hover:bg-green-500 hover:text-white font-bold rounded-lg transition-colors"
                >
                  How It Works
                </Link>
              </div>
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-2xl p-8 text-center">
                ...
                <p className="text-gray-600">
                  Get instant nutrition insights from any meal
                </p>
              </div>
              ...
              <div
                className="absolute -top-4 -right-4 bg-white rounded-lg shadow-lg p-4 animate-bounce"
              ...
              <div
                className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 bg-white rounded-lg shadow-lg p-4 animate-bounce"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 border hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Our AI accurately identifies food items from photos with over
                95% accuracy.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Get detailed macro and micronutrient breakdowns of your meals
                instantly.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Monitor your nutrition goals and track your healthy eating
                progress over time.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Access nutrition analysis anywhere, anytime with our responsive
                web app.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Join a community of health-conscious individuals on their
                nutrition journey.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Simply capture an image of your meal using your device&apos;s
                camera or upload an existing photo.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our advanced AI instantly identifies the food and calculates
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Receive comprehensive nutrition data and personalized health
      ...
      <section className="py-20 bg-gradient-to-r from-green-500 to-blue-500">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already making healthier choices
            with NutriVision.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/login?signup=true"
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-green-500 hover:bg-gray-100 font-bold rounded-lg transition-colors shadow-lg"
            >
              Get Started Free
            </Link>
            <Link
              href="/predict"
              className="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-white hover:bg-white hover:text-green-500 font-bold rounded-lg transition-colors"
            >
              Try Demo
            </Link>
          </div>
